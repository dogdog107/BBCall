	...
	<table cellspacing="0" cellpadding="0" width="100%" align="center" border="0"
		...
		<tr height="28">
			<td background="${pageContext.request.contextPath }/page/img/title_bg1.jpg">當前位置:<a href="defult.jsp"
				target="main">主頁(Home)</a> -> 權限組詳情頁面(AccessGroup Details)
			</td>
		</tr>
		<tr>
	...
	<div class="div_content">
		<div class="div_search">
			<span>
				...
				<input id="btnBack" type="submit" value="編輯權限組/Edit AccessGroup" onclick="location.href='access_showEditAccessGroupPage.action?token=${sessionScope.user_token}&accessgroup_name=${accessgroup_name}'"/>
			</span>
			...
			<table class="table_list" border="1" width="100%">
				<tbody id="datas">
					...
					<tr style="color:#1c94c4">
						<td>權限名字<br/>Access Name</td>
						<td>權限說明<br/>Access Description</td>
					</tr>
