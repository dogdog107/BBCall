...
public class OrderlistAction extends ActionSupport {
	...
	public String deal() throws Exception {
		...
		try {
			...
			if (drivetype.equals(1)) {
				...
				// 苹果推送
				 iosPushServices.iosPush(iosList,
				 "BBCall notification - Your order request has been accepted",2);
			}
	...
	public String complete() throws Exception {
		...
		try {
			...
			if (drivetype.equals(1)) {
				...
				// 苹果推送
				 iosPushServices.iosPush(iosList,
				 "BBCall notification - You have new completed Order",2);
			}
	...
	public String getwashorderlistasc() throws Exception {
		...
		dataMap.clear(); // dataMap中的数据将会被Struts2转换成JSON字符串，所以这里要先清空其中的数据
//
//		if(order_book_location_code == "0" || order_book_location_code.equals("0")) {
